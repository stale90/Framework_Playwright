...
import {Pages, PSYFormReport, PSYFormInputData, PSYValDataWOScenario } from "./PSYTypes";
...
export class Helper {
  ...
  static async refineInputTestData(
    data: PSYFormInputData
  ) {
  ...
  static async prepareInitialReport(
  ...
  static async completePaymentProcess(
    ...
    await test.step(`New Form : Navigate Payment Gateway & Complete Payment`, async () => {
  ...
  static async EditApplicationForm(
    pages: Pages,
    data: PSYFormInputData
  ) {
    ...
    switch (editCase) {
      case 'UR_TO_OBC':
        await TestData.PSY_UR_To_OBC_Gov_Dom_PH(data);
        break;
      case 'UR_TO_EWS':
        await TestData.PSY_UR_To_EWS_Dom_PH(data);
        break;
      case 'OBC_TO_UR':
        await TestData.PSY_OBC_To_UR_Gov_Dom_PH(data);
        break;
      case 'OBC_TO_EWS':
        await TestData.PSY_OBC_To_EWS_Gov_Dom_PH(data);
        break;
      case 'OBC_TO_UR_GN':
        await TestData.PSY_OBC_Gov_PH_Dom_To_UR(data);
        break;
