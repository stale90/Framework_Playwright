...
import { PSYDomicileLocator } from '../locator/PSYDomicileLocator';

export class PSYDomicilePage extends PSYDomicileLocator {
    ...
    async fillDomicileDetails(data: PSYFormInputData) {
...
async compareAlertError(
    ...
    async validateDomicileFields(data: Record<string, PSYValDataWOScenario>) {
