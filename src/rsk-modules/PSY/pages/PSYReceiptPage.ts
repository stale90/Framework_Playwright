...
import { PSYReceiptLocator } from "../locator/PSYReceiptLocator";
import { Actions } from "../../../reusable-component/utility/ActionUtility";
import { PSYFormReport, PSYFormInputData } from "../PSYTypes";

export class PSYReceiptPage extends PSYReceiptLocator {
    ...
    async getReceiptTransactionID(data:PSYFormInputData,report: PSYFormReport) {
    ...
    async verifyPaymentReceiptData(data: PSYFormInputData, report: PSYFormReport) {
    ...
    // Payment Details Verification
    async verifyPaymentDetails(data: PSYFormInputData, report: PSYFormReport) {
    ...
    async verifyApplicantDetails(data: PSYFormInputData) {
    ...
    async verifyOtherDetails(data: PSYFormInputData) {
    ...
    async verifyEducationDetails(data: PSYFormInputData) {
    ...
    async verifyAddressDetails(data: PSYFormInputData) {
    ...
    async verifyUploadDocumentDetails(data: PSYFormInputData) {
