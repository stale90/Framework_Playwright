...
import { DEDMainFormLocator } from '../locator/DEDMainFormLocator';

export class DEDMainFormPage extends DEDMainFormLocator {
    ...
    async checkUserConsent(data: DEDFormInputData) {
