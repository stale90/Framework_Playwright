...
import { DEDOtherFeatureLocator } from "../locator/DEDOtherFeatureLocator";

export class DEDOtherFeaturePage extends DEDOtherFeatureLocator {
    ...
    async resetPassword(report: DEDFormReport) {
    ...
    // Pay Unpaid feature
    async fillPayUnpaidform(report: DEDFormReport) {
    ...
    async fillDuplicateReceiptform(report: DEDFormReport) {
    ...
    async fillRegisterationCancelForm(report: DEDFormReport, data: DEDFormInputData) {
    ...
    // Pay Unpaid feature
    async fillEditAuthenticationForm(report: DEDFormReport) {
