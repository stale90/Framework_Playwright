...
import { DEDExperienceLocator } from '../locator/DEDExperienceLocator';

export class DEDExperiencePage extends DEDExperienceLocator {
    readonly page: Page;
    ...
    async fillExperienceDetails(data: DEDFormInputData) {
    ...
    async validateExperienceFields(data: Record<string, DEDValDataWOScenario>) {
        //--------is Gov Teacher----------
